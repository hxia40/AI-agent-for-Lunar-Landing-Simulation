...
Being a friendly Q, each of the player (assume to be player A) have to assume his/her oppoent will always pick the
action that will benifit player A him/herself most.
...
class Friend_Q_table:
    ...
    def choose_action(self, s, epsilon):
        ...
        if np.random.random() > epsilon:
            ...
            # print("friend_Q.py line 44, argmax, action A, action B", action_A, action_B)
        else:
