...
def SARSA(
    ...
    old_q_sa = q_output_A.loc[(1,2,1), 1]
    ...
    for episode in range(range_end):
        ...
        for t in range(timeout):                     # (3) Repeat (for each step of this episode)
            ...
            if done or t == timeout - 1:
                ...
                new_q_sa = q_output_A.loc[(1,2,1), 1]
    ...
    # plt.ylim([0, .5])
    # plt.show()
    plt.savefig("SARSAmod_a0.5_e0.5_0.9995_0.9995_timeout25.png")
    plt.clf()

    plt.plot(range(num_episode), error_list)
    plt.ylim([0, .5])
    # plt.show()
    plt.savefig("SARSAmod_small_a0.5_e0.5_0.9995_0.9995_timeout25.png")
    plt.clf()

    plt.plot(range(num_episode/100), reward_list_A,
             label="reward for player A")
    plt.savefig("rewards_SARSA_0.9995_0.9995_timeout25.png")
    plt.clf()
...
def friend_Q(
    ...
    range_end = num_episode
    q_output_A, q_outut_B = table_friend_Q.return_Q_table()
    ...
    print("main.py line 152", old_q_sa)
...
def foe_Q(
    ...
    S_file = open('Foe_Q_Learner.txt', 'a')
    print("alpha_decay_rate", alpha_decay_rate)
    print("epsilon_decay_rate", epsilon_decay_rate)
    error_list = []
    delta_list = []
    ...
    range_end = num_episode
    q_output_A, q_outut_B = table_foe_Q.return_Q_table()
    ...
    # plt.ylim([0, .5])
    # plt.show()
    plt.savefig("foeQ_all_0.9995_0.9995_timeout25.png")
    plt.clf()
    ...
    # plt.ylim([0, .5])
    # plt.show()
    plt.savefig("delta_foeQ_all_0.9995_0.9995_timeout25.png")
    plt.clf()
    ...
    plt.ylim([0, .5])
    # plt.show()
    plt.savefig("foeQ_small_0.9995_0.9995_timeout25.png")
    plt.clf()
    ...
    plt.ylim([0, .5])
    # plt.show()
    plt.savefig("delta_foeQ_small_0.9995_0.9995_timeout25.png")
    plt.clf()

    plt.plot(range(num_episode / 100), reward_list_A,
             label="reward for player A")
    plt.savefig("rewards_foeQ_small_0.9995_0.9995_timeout25.png")
    plt.clf()
...
def ce_Q(
    ...
    S_file = open('CE_Q_Learner.txt', 'a')
    print("alpha_decay_rate", alpha_decay_rate)
    print("epsilon_decay_rate", epsilon_decay_rate)
    error_list = []
    delta_list = []
    ...
    range_end = num_episode
    q_output_A, q_outut_B = table_ce_Q.return_Q_table()
    ...
    print("main.py line 498, error_list after all iterations", error_list)
    plt.plot(range(num_episode), error_list,
             label="Q")
    # plt.ylim([0, .5])
    # plt.show()
    plt.savefig("ceQ_all_0.9995_0.9995_timeout25.png")
    plt.clf()
    ...
    # plt.ylim([0, .5])
    # plt.show()
    plt.savefig("delta_ceQ_all_0.9995_0.9995_timeout25.png")
    plt.clf()
    ...
    plt.ylim([0, .5])
    # plt.show()
    plt.savefig("ceQ_small_0.9995_0.9995_timeout25.png")
    plt.clf()
    ...
    plt.ylim([0, .5])
    # plt.show()
    plt.savefig("delta_ceQ_small_0.9995_0.9995_timeout25.png")
    plt.clf()

    plt.plot(range(num_episode / 100), reward_list_A,
             label="reward for player A")
    plt.savefig("rewards_ceQ_small_0.9995_0.9995_timeout25.png")
    plt.clf()
