...
class DQN:
    ...
    def initialize_model(self):
        model = Sequential()
        model.add(Dense(100, input_dim=self.num_observation_space, activation=relu))
...
#         model.add(Dense(24, input_dim=self.num_observation_space, activation="relu"))
...
#     # Save trained model
#     model.save("trained_model_100_NN_maxlen_50000.h5")
...
#     plot_df(reward_df, "Figure 1: Reward for each training episode_100_NN_maxlen_50000", "Reward for each training episode", "Episode","Reward")
