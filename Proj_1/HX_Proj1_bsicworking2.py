...
if __name__ == '__main__':
    all_sets = make_train_sets(num_train_set=100,num_sequences=10, random_seed=3)  # somehow then num_sequence larger than 100, say 1000, the value estimate will go crazy. using a smaller alhpa helps.
    # print(all_sets)
